...
import torch
import numpy as np
from layer_segmentation_network_128 import U_Net
...
if __name__ == '__main__':
    ...
    cross_entropy = nn.CrossEntropyLoss(
        weight=torch.FloatTensor([0.008532196145313574, 1.4945117611710765, 1.49695604268361]).to(device))
    print(torch.cuda.device_count())
    ...
    model_path = 'saved_model0_20000(20210608_2).pt'
    ...
    for z in range(1, 201):
        ...
        label = data_file[1, :].reshape((128, 128, 128))
        torch.cuda.empty_cache()
        # for i in range(3):
        #     for j in range(3):
        #         for k in range(3):
